...
Keyword meanings were scraped from Labyrinthos (labyrinthos.co), targeting the structured keyword table on each card page rather than the full prose descriptions. This was a deliberate choice — prose text is editorially biased toward positive framing even for difficult cards, while keywords are more neutral and discriminative.

•	78 cards × 2 orientations = 156 rows
•	Source: labyrinthos.co/blogs/tarot-card-meanings-list
•	Only the upright/reversed keyword tables were scraped — not the full article text
•	Polite crawl delays (3–5 seconds between requests) and retry logic for 503 errors
