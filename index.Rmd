...
Keyword meanings were scraped from Labyrinthos (labyrinthos.com), targeting the structured keyword table on each card page rather than the full prose descriptions. Prose text is editorially biased toward positive framing even for difficult cards, while keywords are more neutral and discriminative.
